...
│   ├── core/               # Ядро бота (команды /start, /menu)
│   │   ├── __init__.py     # Экспорт core_router
│   │   └── router.py       # Глобальные команды
...
│   │   ├── config.py       # Модульные настройки email
│   │   ├── messages.py     # Сообщения только этого модуля
│   │   ├── keyboards.py    # Клавиатуры email модуля
│   │   ├── services.py     # Сервисы email модуля
...
│
├── keyboards/              # Глобальные клавиатуры
...
- **🏗️ Устойчивая архитектура** - глобальные команды в core модуле, независимо от других модулей
